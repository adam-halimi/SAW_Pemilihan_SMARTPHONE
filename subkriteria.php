                ...
                <div class="col-md-16">
                  <!--   Kitchen Sink -->
                    <div class="panel panel-default">
                        ...
                        $aksi = @$_GET['aksi'];
                        if(($aksi<>"") and ($id_sub<>"")){
                             mysql_query("delete from subkriteria where id_sub='$id_sub'") or die (mysql_error());
                            ...
                            <div class="datatable table-responsive">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        include "koneksi.php";
                                        $nomor = 0;
                                        $result = mysql_query("SELECT * FROM subkriteria, kriteria WHERE subkriteria.id_kriteria=kriteria.id_kriteria order by subkriteria.id_sub asc") or die (mysql_error());
